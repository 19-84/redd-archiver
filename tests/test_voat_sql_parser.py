...
class TestVoatSQLParserIntegration:
    ...
    def create_test_file(self, sql_content):
        ...
        with tempfile.NamedTemporaryFile(suffix=".sql.gz", delete=False) as f:
            pass  # we only need the reserved path; gzip reopens it below
