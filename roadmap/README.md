...
| 2 | [Dynamic Serving Mode](02-dynamic-serving-mode.md) | Flask serves all pages (5 phases) | Implemented incl. Phase 5 caching (top50 rankings deferred) |
| 3 | [Incremental Update System](03-incremental-update-system.md) | Arctic Shift monthly imports (4 phases) | Implemented |
| 4 | [Visual Themes](04-visual-themes.md) | CSS theme system (4 phases) | Implemented (Phases 1–4; persistence toggles deferred) |
...
| 7 | [Voat Data Enrichment](07-voat-data-enrichment.md) | Subverse metadata, user profiles, thumbnails, flair (5 phases) | Implemented (top50 rankings deferred) |
| 8 | [Pyright Type Checking](08-pyright-type-checking.md) | Add pyright standard mode, CI integration | Done (Phases 1–2; gradual strictness ongoing) |
| 9 | [SIM + RUF Ruff Rules](09-ruff-sim-ruf-rules.md) | Enable flake8-simplify and Ruff-specific rules | Done |
| 10 | [Pre-Commit Hooks](10-pre-commit-hooks.md) | Activate local pre-commit hooks with ruff | Done |
| 11 | [Docker Python Alignment](11-docker-python-version-alignment.md) | Fix 3.14 vs 3.12 version mismatch | Done |
